    ...
    <>
      ...
      <main id="main-content" className="container mx-auto px-4 py-12 min-h-screen">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">3. Services</h2>
            <p className="text-foreground/90 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">4. Engagement and Consultations</h2>
            <p className="text-foreground/90 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">5. Cancellation and Rescheduling</h2>
            <p className="text-foreground/90 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">9. Confidentiality</h2>
            <p className="text-foreground/90 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">18. Contact Us</h2>
            <p className="text-foreground/90 mb-4">
