      ...
      <main id="main-content" className="container mx-auto px-4 py-12 min-h-screen">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/90 mb-4">We may collect and process the following categories of personal data:</p>
            
            <h3 className="text-xl font-semibold mb-3 text-foreground">3.1 Information You Provide Directly</h3>
            ...
            <h3 className="text-xl font-semibold mb-3 text-foreground">3.2 Information Collected Automatically</h3>
            <ul className="list-disc pl-6 text-foreground/90 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">4. Lawful Basis for Processing</h2>
            <p className="text-foreground/90 mb-4">Under UK GDPR, we must have a lawful basis for processing your personal data. We rely on the following legal bases:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/90 mb-4">We use your personal data for the following purposes:</p>
            <ul className="list-disc pl-6 text-foreground/90 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">7. Data Sharing and Disclosure</h2>
            <p className="text-foreground/90 mb-4">We do not sell, trade, or rent your personal data to third parties. We may share your information in the following circumstances:</p>
            <ul className="list-disc pl-6 text-foreground/90 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">10. Your Rights Under UK GDPR</h2>
            <p className="text-foreground/90 mb-4">Under UK GDPR, you have the following rights regarding your personal data:</p>
            <ul className="list-disc pl-6 text-foreground/90 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">11. Cookies</h2>
            <p className="text-foreground/90 mb-4">
