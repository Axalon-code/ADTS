...
const ServiceCard = ({ id, icon, title, items }: ServiceCardProps) => (
  <Card id={id} className="bg-white shadow-md">
    <CardContent className="p-8">
      <div className="flex items-center mb-6">
        <div className="bg-primary bg-opacity-10 p-4 rounded-md mr-4">
          <i className={`${icon} text-primary text-2xl`}></i>
        </div>
        <h3 className="font-inter font-semibold text-2xl">{title}</h3>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16">
          <Card className="bg-white shadow-md">
            <CardContent className="p-8">
              <h3 className="font-inter font-semibold text-2xl mb-6">Services Not Offered</h3>
