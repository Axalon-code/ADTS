              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-primary bg-opacity-10 p-3 rounded-md mr-4">
                      <i className="fas fa-envelope text-primary"></i>
                    </div>
                    <div>
                      <p className="font-medium">Email</p>
                      <a href="mailto:contact@adts.com" className="text-primary hover:text-accent transition-colors">
                        contact@adts.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+441234567890" className="text-primary hover:text-accent transition-colors">
                        +44 (0) 123 456 7890
                      </a>
                    </div>
                  </div>
            ...
            <Card className="bg-white shadow-md">
              <CardContent className="p-8">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-globe-europe text-primary mr-3"></i>
