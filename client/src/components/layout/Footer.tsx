...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary text-white py-8 sm:py-12 3xl:py-16 4xl:py-20">
      <div className="container-responsive">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 3xl:gap-10 4xl:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => scrollToSection("services")} className="hover:text-accent transition-colors text-[18px]">
                  Services
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection("about")} className="hover:text-accent transition-colors text-[18px]">
                  About Me
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection("contact")} className="hover:text-accent transition-colors text-[18px]">
                  Contact
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => scrollToSection("azure-services")} className="hover:text-accent transition-colors text-[18px]">
                  Microsoft Azure
                </button>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            <Link href="/privacy" className="hover:text-accent transition-colors text-[20px]">
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-accent transition-colors text-[20px]">
              Terms of Service
            </Link>
          </div>
        </div>
